...
final class NotePostType {
	public static function register(): void {
		...
		$labels = [
			...
			'name_admin_bar'     => _x( 'Informational Note', 'add new from admin bar', 'note-cpt' ),
			'add_new'            => _x( 'Add New Informational Note', 'add new', 'note-cpt' ),
			'add_new_item'       => _x( 'Add New Informational Note', 'add new item', 'note-cpt' ),
